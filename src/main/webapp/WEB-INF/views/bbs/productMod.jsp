...
<body>
	<div id="main">
		<section>
			<form action="modipyAction" method="post" id="pForm"
				...
				<div id="productModipy">
					...
					<div class="cate_wrap">
						...
						<div class="search_boxes">
							<span class="search_box"> <select name="cate1"
								value="${pvo.cate1}"></select> <select name="cate2"
								value="${pvo.cate2}"></select>
							</span>
						</div>
						<div class="mb-3">
...
<script type="text/javascript">
	$('document').ready(
			function() {
				...
				$("select[name^=cate]").each(
						function() {
							$selcate = $(this);
							$.each(eval(area0), function() {
								$selcate.append("<option value='"+this+"'>"
										+ this + "</option>");
							});
							$selcate.next().append(
				...
				$("select[name^=cate]").change(
						function() {
							var area = "area"
									+ $("option", $(this)).index(
											$("option:selected", $(this))); // 선택 Array
							...
							if (area == "area0")
								...
								$.each(eval(area), function() {
									$ccate.append("<option value='"+this+"'>"
											+ this + "</option>");
								});
							}
						});
